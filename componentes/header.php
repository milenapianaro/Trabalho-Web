...
<body>
    <header class="cabecalho-site">
        <div class="cabecalho-principal">
            <a class="logo-cabecalho" href="../pags_php/pagina-inicial.php" aria-label="Página Inicial">
            ...
            <nav class="navegacao-cabecalho" aria-label="Navegação principal">
                <a class="link-navegacao" id="nav-aluno" href="../pags_php/sou-aluno.php">
                    <img class="seta-navegacao" id="seta-aluno" src="../Imagens/Matriz Curricular/seta.png" alt="">
                    Sou Aluno
                </a>
                <a class="link-navegacao" href="../pags_php/quero-ser-aluno.php">Quero Ser Aluno</a>
                <a class="link-navegacao" href="../pags_php/form-contato.php">Contato</a>
            </nav>
        ...
        <div class="menu-suspenso" id="menu-suspenso" aria-hidden="true">
            <nav class="navegacao-suspensa" aria-label="Menu do aluno">
                <a href="../pags_php/form-login-mural.php">Mural dos Estudantes</a>
                <a href="../pags_php/manual-aluno.php">Manual do Aluno</a>
                <a href="../pags_php/plataformas.php">Plataformas e Recursos</a>
                <a href="../pags_php/matriz-curricular.php">Matriz Curricular</a>
                <a href="../pags_php/atendimento.php">E-mails e Atendimento</a>
            </nav>
        </div>
    </header>
